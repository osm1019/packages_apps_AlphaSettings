...
import com.alpha.settings.utils.PreferenceUtils;
...
public class Spoofing extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Tensor targets: only relevant on non-Tensor devices (pref may be deferred)
        if (mTensorTargets != null && mFeaturesCategory != null
                && PixelPropsUtils.isTensorPixelDevice()) {
